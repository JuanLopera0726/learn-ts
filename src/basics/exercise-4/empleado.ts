 ...
 * los métodos y se puede marcar con la palabra reservada override. Permite el uso de modificadores
 * de acceso. 
 */
...
export abstract class Empleado {
    ...
    // Firma de un método(NO se implementa aquí) - Quien use la clase base debe implementar
